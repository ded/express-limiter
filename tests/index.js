var chai = require('chai')
  ...
  , subject = require('../')
  , db = mongojs('localhost/test')
  , mycollection = db.collection('mycollection')

chai.use(require('sinon-chai'))

describe('rate-limiter-redis', function () {
...
describe('rate-limiter-mongodb', function () {
  var express, app, limiter

  beforeEach(function () {
    express = require('express')
    app = express()
    limiter = subject(app, mycollection, 'mongodb')
  })

  afterEach(function (done) {
    mycollection.remove({}, done)
  })
